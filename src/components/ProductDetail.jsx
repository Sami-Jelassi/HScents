  ...
  return (
    <Box sx={{ bgcolor: colors.white, minHeight: '100vh', pt: 4, pb: 8 }}>
      <Container maxWidth="xl">
        {/* Breadcrumbs */}
        <Breadcrumbs sx={{ mb: 3, fontFamily: "'Assistant', sans-serif" }}>
          <MuiLink 
            component={Link} 
            to="/" 
            underline="hover" 
          ...
          <Typography color={colors.accentGold} sx={{ fontFamily: "'Assistant', sans-serif", fontWeight: 500 }}>
            {product.name}
          </Typography>
        </Breadcrumbs>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            >
              ...
              {product.shortDescription && (
                <Typography variant="body1" sx={{ color: '#666', mb: 3, fontFamily: "'Assistant', sans-serif", lineHeight: 1.6 }}>
                  {product.shortDescription}
                </Typography>
              )}
              ...
              {/* Size Selection */}
              <Typography variant="subtitle1" sx={{ fontWeight: 600, color: colors.navyDark, mb: 2, fontFamily: "'Assistant', sans-serif" }}>
                Select Size
              </Typography>
                ...
                {product.sizes.map((size) => (
                  <Grid size={{ xs: 4, sm: 3 }} key={size.size}>
                    <motion.div whileHover={{ y: -2 }} transition={{ duration: 0.2 }}>
                      ...
                      >
                        <Typography variant="subtitle1" sx={{ fontWeight: 700, color: colors.navyDark, fontFamily: "'Assistant', sans-serif" }}>
                          {size.size}
                        </Typography>
                        <Typography variant="body2" sx={{ fontWeight: 600, color: colors.navyDark, fontFamily: "'Assistant', sans-serif" }}>
              ...
              <Alert 
                ...
                sx={{ mb: 3, borderRadius: '12px', fontFamily: "'Assistant', sans-serif" }}
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', border: `1px solid ${alpha(colors.navyDark, 0.2)}`, borderRadius: '50px' }}>
                  ...
                  <Typography sx={{ px: 3, minWidth: 40, textAlign: 'center', fontFamily: "'Assistant', sans-serif", fontWeight: 600 }}>
                    {quantity}
                  </Typography>
                  <IconButton 
                    onClick={() => handleQuantityChange(1)} 
                ...
                <Button
                  ...
                  sx={{
                    ...
                    fontFamily: "'Assistant', sans-serif",
                    letterSpacing: '0.5px',
                    '&:hover': { bgcolor: colors.navyDark, transform: 'translateY(-2px)' },
              ...
              {product.description && (
                <Paper sx={{ borderRadius: '16px', overflow: 'hidden', mb: 2, border: `1px solid ${alpha(colors.navyDark, 0.1)}` }}>
                  ...
                  <Box sx={{ p: 2.5 }}>
                    <Typography variant="body1" sx={{ whiteSpace: 'pre-wrap', color: '#666', lineHeight: 1.6, fontFamily: "'Assistant', sans-serif" }}>
                      {product.description}
                    </Typography>
                  </Box>
                </Paper>
              ...
              {product.notes && (
                <Paper sx={{ borderRadius: '16px', overflow: 'hidden', border: `1px solid ${alpha(colors.navyDark, 0.1)}` }}>
                  ...
                  <Box sx={{ p: 2.5 }}>
                    <Typography variant="body1" sx={{ color: '#666', lineHeight: 1.6, fontFamily: "'Assistant', sans-serif" }}>
                      {product.notes}
                    </Typography>
                  </Box>
                </Paper>
              ...
              <Grid container spacing={3}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    ...
                    sx={{ 
                      ...
                      '& .MuiInputLabel-root': { fontFamily: "'Assistant', sans-serif" },
                      '& .MuiOutlinedInput-input': { fontFamily: "'Assistant', sans-serif" },
                    }}
                  />
                </Grid>
                <Grid size={{ xs: 12, md: 6 }}>
                ...
                <Grid size={{ xs: 12 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, p: 2.5, bgcolor: alpha(colors.accentGold, 0.08), borderRadius: '12px' }}>
                    ...
                    <Typography variant="body2" sx={{ color: colors.navyDark, fontFamily: "'Assistant', sans-serif" }}>
                ...
                <Grid size={{ xs: 12 }}>
                  <Button
                    ...
                    sx={{
                      ...
                      fontFamily: "'Assistant', sans-serif",
                      letterSpacing: '0.5px',
                      '&:hover': { bgcolor: colors.navyGlow, transform: 'translateY(-2px)' },
                      transition: 'all 0.3s ease',
                    }}
                  >
        ...
        <Dialog open={orderDialogOpen} onClose={() => setOrderDialogOpen(false)} maxWidth="sm" fullWidth>
          <DialogTitle sx={{ bgcolor: colors.navyDark, color: colors.white, textAlign: 'center', fontFamily: "'Assistant', sans-serif", fontWeight: 700 }}>
            Order Summary
            <IconButton
          ...
          <DialogContent sx={{ p: 3 }}>
            <Paper sx={{ p: 2.5, mb: 3, bgcolor: alpha(colors.navyDark, 0.03), borderRadius: '16px' }}>
              <Typography variant="subtitle1" sx={{ fontWeight: 700, color: colors.navyDark, mb: 2, fontFamily: "'Assistant', sans-serif" }}>
                Order Details
              </Typography>
              <Stack direction="row" justifyContent="space-between" sx={{ mb: 1 }}>
                <Typography variant="body2" sx={{ fontFamily: "'Assistant', sans-serif", color: '#666' }}>Product</Typography>
              ...
              <Stack direction="row" justifyContent="space-between" sx={{ mb: 1 }}>
                <Typography variant="body2" sx={{ fontFamily: "'Assistant', sans-serif", color: '#666' }}>Quantity</Typography>
                <Typography variant="body2" sx={{ fontFamily: "'Assistant', sans-serif", color: colors.navyDark }}>{quantity}</Typography>
              </Stack>
              <Stack direction="row" justifyContent="space-between" sx={{ mb: 1 }}>
                <Typography variant="body2" sx={{ fontFamily: "'Assistant', sans-serif", color: '#666' }}>Unit Price</Typography>
